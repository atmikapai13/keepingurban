      ...
      <section className="statement" id="open-call">
        <div className="statement-content">
          ...
          <div className="statement-text">
            <p>
              With over half the world population now living in cities, <span style={{color: '#ff3d00'}}>Keeping It Urban</span> is not about urbanism itself, rather the <span className="text-highlight-wave"><span style={{animationDelay: '0s'}}>confluence</span> <span style={{animationDelay: '0.1s'}}>of</span> <span style={{animationDelay: '0.2s'}}>tech,</span> <span style={{animationDelay: '0.3s'}}>arts,</span> <span style={{animationDelay: '0.4s'}}>and</span> <span style={{animationDelay: '0.5s'}}>culture</span> <span style={{animationDelay: '0.6s'}}>that</span> <span style={{animationDelay: '0.7s'}}>is</span> <span style={{animationDelay: '0.8s'}}>born</span> <span style={{animationDelay: '0.9s'}}>only</span> <span style={{animationDelay: '1.0s'}}>from</span> <span style={{animationDelay: '1.1s'}}>the</span> <span style={{animationDelay: '1.2s'}}>density</span> <span style={{animationDelay: '1.3s'}}>of</span> <span style={{animationDelay: '1.4s'}}>cities.</span></span>
            </p>
            <p>
              The summit reclaims from top-down silos.
            </p>
            <p>
              It brings together cultural agents - artists, technologists, civic leaders, and funders - that have been <span className="text-highlight-wave"><span style={{animationDelay: '0s'}}>independently</span> <span style={{animationDelay: '0.1s'}}>shaping</span> <span style={{animationDelay: '0.2s'}}>livable</span> <span style={{animationDelay: '0.3s'}}>cities</span> <span style={{animationDelay: '0.4s'}}>into</span> <span style={{animationDelay: '0.5s'}}>the</span> <span style={{animationDelay: '0.6s'}}>same</span> <span style={{animationDelay: '0.7s'}}>room</span> <span style={{animationDelay: '0.8s'}}>to</span></span> <span className="text-highlight-wave orange"><span style={{animationDelay: '0.9s'}}>NOW</span></span> <span className="text-highlight-wave"><span style={{animationDelay: '1.0s'}}>build</span></span> <span className="text-highlight-wave orange"><span style={{animationDelay: '1.1s'}}>TOGETHER.</span></span>
            </p>
          </div>
        </div>
      </section>
